...
//定义回调接口
typedef HallTimeSelectorCallback3 = Function(List<int> results);

/*
 * 餐厅筛选栏自定义横向选择器 Widget
 **/
class HallCustomScrollSelector3 extends StatefulWidget {
  final title;
  ...
  //回调函数
  HallTimeSelectorCallback3 callback;
  ...
  State<StatefulWidget> createState() {
    return HallCustomScrollSelector3State();
  }
}

class HallCustomScrollSelector3State extends State<HallCustomScrollSelector3> {
  @override
