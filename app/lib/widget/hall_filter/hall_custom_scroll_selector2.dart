...
//定义回调接口
typedef HallTimeSelectorCallback2 = Function(List<int> results);

/*
 * 餐厅筛选栏自定义横向选择器 Widget
 **/
class HallCustomScrollSelector2 extends StatefulWidget {
  final title;
  ...
  //回调函数
  HallTimeSelectorCallback2 callback;
  ...
  State<StatefulWidget> createState() {
    return HallCustomScrollSelector2State();
  }
}

class HallCustomScrollSelector2State extends State<HallCustomScrollSelector2> {
  @override
