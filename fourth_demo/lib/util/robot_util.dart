...
import 'package:fourth_demo/model/robot_message.dart';
import 'package:fourth_demo/event/event_robot_respone.dart';

class RobotUtil {
  var url = "https://api.ai.qq.com/fcgi-bin/nlp/nlp_textchat";
  var app_id = "2118304431";
  var app_key = "b8ouOtJBpcFgjfkx";
